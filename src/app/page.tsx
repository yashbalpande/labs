...
export default function Home() {
  ...
  return (
    <div key="home-page" className="min-h-screen w-full bg-white text-[#54453E]">
      ...
      <div className="hidden md:flex mt-[15%] mb-10 justify-center items-center w-full px-8">
        <div className="max-w-5xl w-full flex flex-row justify-between items-center gap-10">
          <div className="text-left w-1/2">
            <h1 className="text-3xl font-lilita text-[#54453E] font-bold mb-3">The Lab's Core Experiments</h1>
            <Link href="/services"><button className="bg-sky-300 text-[#54453E] font-montserrat px-6 py-2 rounded-md cursor-pointer">All Services</button></Link>
          </div>
          <div className="text-sm text-[#54453E] font-montserrat text-left w-1/2">
            <p>This isn't a list of services. <br />It's a set of controlled experiments <br />designed to engineer real growth.</p>
          </div>
        </div>
      </div>
  
      <div className="flex md:hidden mt-6 mb-6 flex-col justify-center items-center w-full px-2">
        <div className="w-full flex flex-col gap-3">
          <div className="text-center w-full mb-2">
            <h1 className="text-xl font-lilita text-[#54453E] font-bold mb-2">The Lab's Core Experiments</h1>
            <Link href="/services"><button className="bg-sky-300 text-[#54453E] font-montserrat px-4 py-2 rounded-md cursor-pointer text-sm">All Services</button></Link>
          </div>
          <div className="text-xs text-[#54453E] font-montserrat text-center w-full">
            <p>This isn't a list of services. <br />It's a set of controlled experiments <br />designed to engineer real growth.</p>
          </div>
        </div>
      </div>
      <div className="relative mt-[25%]">
        ...
        <div className="absolute top-[-150%] left-1/2 font-montserrat transform -translate-x-1/2 flex gap-6">
          <Card
            icon="/mark-icon.png"
            index="01"
      ...
      <div className="w-[70%] h-auto border border-[#4DD1F4] border-t-0 mt-0 mx-auto rounded-b-lg pb-7">
        <div className="flex flex-col items-center justify-center mt-0 text-center pt-20">
          <h2 className="text-4xl md:text-4xl text-[#54453E] font-montserrat font-thin">
            Real Brands. Real Experiments.
          </h2>
          <h2 className="text-2xl md:text-2xl font-bold text-[#54453E] font-montserrat font-semibold mb-4">
            Real Results.
          </h2>
        ...
        <div ref={logosRef} className={`mt-[7%] ${animateLogos ? "animate-in" : ""}`}>
          ...
          <div className="flex items-center justify-between mt-5 mr-10 mb-0">
            ...
            <div className="h-36 w-36 border-1 rounded-md border-[#4DD1F4] transform rotate-[14.96deg] fall-in"
      ...
      <div className="w-full relative bg-white mt-20">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 px-8 max-w-6xl mx-auto mb-2">
          ...
          <p className="text-[#54453E] font-montserrat text-center md:text-left text-base leading-relaxed mt-2">
