      ...
      <div className="mt-[15%] mb-10 flex justify-center items-center w-full px-4">
        <div className="max-w-5xl w-full flex flex-col md:flex-row justify-between items-center gap-10">
          ...
          <div className="text-center md:text-left md:w-1/2">
            <h1 className="text-3xl font-lilita text-[#54453E]  font-bold  text-outline-[##000000] mb-3">
              The Lab's Core Experiments
            </h1>
            <Link href="/services">
              <button className="bg-sky-300 text-[#54453E] font-montserrat px-6 py-2 rounded-md cursor-pointer">
                All Services
              </button>
            </Link>
          </div>
          <div className="text-sm text-[#54453E] font-montserrat text-center md:text-left md:w-1/2">
            <p>
